...
echo "You can download the partially presynced blockchain from: https://github.com/RichcoinCoin/RIchCoin/releases/tag/b385"
...
#    do
#    sleep 1
#    echo "wget" $(lynx --dump --listonly https://RichcoinCoin.de | grep -o "https:*.*zip") > link.sh
#    sleep 1
#    sh link.sh
#    done
#    
#    #checksum
#    sudo rm blockchain
#    wget https://www.RichcoinCoin.github.io/checksums/blockchain
