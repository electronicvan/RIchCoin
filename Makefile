...
pkgdatadir = $(datadir)/RIchCoin
pkgincludedir = $(includedir)/RIchCoin
pkglibdir = $(libdir)/RIchCoin
pkglibexecdir = $(libexecdir)/RIchCoin
...
CONFIG_HEADER = $(top_builddir)/src/config/RIchCoin-config.h
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/src/config/RIchCoin-config.h.in COPYING INSTALL \
...
ACLOCAL = ${SHELL} /home/randummy/RIchCoin/src/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /home/randummy/RIchCoin/src/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/randummy/RIchCoin/src/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/randummy/RIchCoin/src/build-aux/missing automake-1.15
AWK = mawk
BDB_CPPFLAGS = 
...
MAINT = 
MAKEINFO = ${SHELL} /home/randummy/RIchCoin/src/build-aux/missing makeinfo
MAKENSIS = 
MKDIR_P = /bin/mkdir -p
MOC = /usr/bin/moc
...
OTOOL = 
PACKAGE = RIchCoin
PACKAGE_BUGREPORT = https://github.com/RIchCoin/shield/issues
PACKAGE_NAME = RIchCoin Core
PACKAGE_STRING = RIchCoin Core 2.1.0
PACKAGE_TARNAME = RIchCoin
PACKAGE_URL = http://RIchCoin.github.io/
...
abs_builddir = /home/randummy/RIchCoin
abs_srcdir = /home/randummy/RIchCoin
abs_top_builddir = /home/randummy/RIchCoin
abs_top_srcdir = /home/randummy/RIchCoin
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_OBJC = gcc
ac_ct_OBJCXX = g++
...
install_sh = ${SHELL} /home/randummy/RIchCoin/src/build-aux/install-sh
...
SUBDIRS = src
GZIP_ENV = "-9n"
BITCOIND_BIN = $(top_builddir)/src/RIchCoind$(EXEEXT)
BITCOIN_QT_BIN = $(top_builddir)/src/qt/RIchCoin-qt$(EXEEXT)
BITCOIN_WIN_INSTALLER = $(PACKAGE)-$(PACKAGE_VERSION)-win$(WINDOWS_BITS)-setup$(EXEEXT)
OSX_APP = RIchCoin-Qt.app
OSX_DMG = RIchCoin-Qt.dmg
OSX_DEPLOY_SCRIPT = $(top_srcdir)/contrib/macdeploy/macdeployqtplus
OSX_FANCY_PLIST = $(top_srcdir)/contrib/macdeploy/fancy.plist
OSX_INSTALLER_ICONS = $(top_srcdir)/src/qt/res/icons/RIchCoin.icns
OSX_PLIST = $(top_srcdir)/share/qt/Info.plist #not installed
OSX_QT_TRANSLATIONS = da,de,es,hu,ru,uk,zh_CN,zh_TW
DIST_DOCS = $(wildcard doc/*.md) $(wildcard doc/release-notes/*.md)
WINDOWS_PACKAGING = $(top_srcdir)/share/pixmaps/RIchCoin.ico \
...
OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/RIchCoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/RIchCoin-Qt
...
src/config/RIchCoin-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/RIchCoin-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/RIchCoin-config.h
$(top_srcdir)/src/config/RIchCoin-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/RIchCoin-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/Resources/RIchCoin.icns: $(OSX_INSTALLER_ICONS)
	$(MKDIR_P) $(@D)
	$(INSTALL_DATA) $< $@

$(OSX_APP)/Contents/MacOS/RIchCoin-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(OSX_DMG): $(OSX_APP_BUILT) $(OSX_PACKAGING)
	...
	$(GENISOIMAGE) -no-cache-inodes -l -probe -V "RIchCoin-Qt" -no-pad -r -apple -o $@ dist
...
#	$(LCOV) -c -d $(abs_builddir)/src --t RIchCoinJBlockTest -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb
