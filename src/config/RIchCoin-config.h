/* src/config/RIchCoin-config.h.  Generated from RIchCoin-config.h.in by configure.  */
/* src/config/RIchCoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef RIchCoin_CONFIG_H

#define RIchCoin_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://github.com/RichcoinCoin/richcoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "RIchCoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "RIchCoin Core 2.3.4"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "RIchCoin"

/* Define to the home page for this package. */
#define PACKAGE_URL "http://RichcoinCoin.github.io/"
