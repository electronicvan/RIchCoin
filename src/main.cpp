...
int nCoinbaseMaturity = 180; //R: rewards mature after 180+20= 200 blocks
...
static const int64 nTargetTimespan = 1 * 20 * 60;  // 20 min
static const int64 nTargetSpacingWorkMax = 3 * nStakeTargetSpacing; // 1 minute 30 sec
