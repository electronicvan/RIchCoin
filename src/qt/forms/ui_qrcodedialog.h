...
public:
    ...
    void setupUi(QDialog *QRCodeDialog)
    {
        ...
        outUri->setMinimumSize(QSize(0, 49));
        outUri->setStyleSheet(QLatin1String("\n"
...
"max-height: 45px;"));
        ...
        lnLabel->setStyleSheet(QLatin1String("\n"
"border-top-left-radius: 5px;\n"
"border-top-right-radius: 5px;\n"
"border-bottom-left-radius: 5px;\n"
"border-bottom-right-radius: 5px;\n"
...
"max-height: 25px;"));
        ...
        lnMessage->setStyleSheet(QLatin1String("\n"
"border-top-left-radius: 5px;\n"
"border-top-right-radius: 5px;\n"
"border-bottom-left-radius: 5px;\n"
"border-bottom-right-radius: 5px;\n"
...
"max-height: 25px;"));
        ...
        lnReqAmount->setMinimumSize(QSize(80, 29));
        lnReqAmount->setStyleSheet(QLatin1String("\n"
"border-top-left-radius: 5px;\n"
"border-top-right-radius: 5px;\n"
"border-bottom-left-radius: 5px;\n"
"border-bottom-right-radius: 5px;\n"
...
"max-height: 25px;"));
        ...
        btnSaveAs->setStyleSheet(QLatin1String("\n"
"border-top-left-radius: 5px;\n"
"border-top-right-radius: 5px;\n"
"border-bottom-left-radius: 5px;\n"
"border-bottom-right-radius: 5px;\n"
