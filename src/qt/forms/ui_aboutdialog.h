...
"max-width: 100px;"));
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About RIchCoin", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>RIchCoin</b> version", 0));
        copyrightLabel->setText(QApplication::translate("AboutDialog", "Copyright \302\251 2017 RIchCoin", 0));
...
"\n"
"Offical Website: http://RIchCoin.github.io\n"
"\n"
"Special Thanks to: Sunerok, CryptoRekt, MKinney, BearSylla, Hypermist, Pallas1, FuzzBawls, BuZz, glodfinch, InfernoMan, AhmedBodi, BitSpill, MentalCollatz, and the -entire- #RIchCoin irc community!\n"
"\n"
"HTP!", 0));
    } // retranslateUi
