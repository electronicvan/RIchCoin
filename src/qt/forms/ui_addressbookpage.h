...
"border: 2px solid #000000;"));
        ...
        newAddressButton->setStyleSheet(QLatin1String("border-top-left-radius: 5px;\n"
"border-top-right-radius: 5px;\n"
"border-bottom-left-radius: 5px;\n"
"border-bottom-right-radius: 5px;\n"
"border: 2px solid #000000;\n"
...
"max-width: 95px;"));
        ...
        copyToClipboard->setStyleSheet(QLatin1String("border-top-left-radius: 5px;\n"
"border-top-right-radius: 5px;\n"
"border-bottom-left-radius: 5px;\n"
"border-bottom-right-radius: 5px;\n"
"border: 2px solid #000000;\n"
...
"max-width: 95px;"));
        ...
        showQRCode->setStyleSheet(QLatin1String("border-top-left-radius: 5px;\n"
"border-top-right-radius: 5px;\n"
"border-bottom-left-radius: 5px;\n"
"border-bottom-right-radius: 5px;\n"
"border: 2px solid #000000;\n"
...
"max-width: 95px;"));
        ...
        signMessage->setStyleSheet(QLatin1String("border-top-left-radius: 5px;\n"
"border-top-right-radius: 5px;\n"
"border-bottom-left-radius: 5px;\n"
"border-bottom-right-radius: 5px;\n"
"border: 2px solid #000000;\n"
...
"max-width: 95px;"));
        ...
        verifyMessage->setStyleSheet(QLatin1String("border-top-left-radius: 5px;\n"
"border-top-right-radius: 5px;\n"
"border-bottom-left-radius: 5px;\n"
"border-bottom-right-radius: 5px;\n"
"border: 2px solid #000000;\n"
...
"max-width: 95px;"));
        ...
        deleteButton->setStyleSheet(QLatin1String("border-top-left-radius: 5px;\n"
"border-top-right-radius: 5px;\n"
"border-bottom-left-radius: 5px;\n"
"border-bottom-right-radius: 5px;\n"
"border: 2px solid #000000;\n"
...
"max-width: 95px;"));
        ...
        buttonBox->setStyleSheet(QLatin1String("border-top-left-radius: 5px;\n"
"border-top-right-radius: 5px;\n"
"border-bottom-left-radius: 5px;\n"
"border-bottom-right-radius: 5px;\n"
"border: 2px solid #000000;\n"
...
"max-width: 85px;"));
    ...
    void retranslateUi(QWidget *AddressBookPage)
    {
        ...
        labelExplanation->setText(QApplication::translate("AddressBookPage", "These are your RIchCoin addresses for receiving payments. You may want to give a different one to each sender so you can keep track of who is paying you.", 0));
...
#ifndef QT_NO_TOOLTIP
        signMessage->setToolTip(QApplication::translate("AddressBookPage", "Sign a message to prove you own a RIchCoin address", 0));
#endif // QT_NO_TOOLTIP
        signMessage->setText(QApplication::translate("AddressBookPage", "Sign &Message", 0));
#ifndef QT_NO_TOOLTIP
        verifyMessage->setToolTip(QApplication::translate("AddressBookPage", "Verify a message to ensure it was signed with a specified RIchCoin address", 0));
#endif // QT_NO_TOOLTIP
