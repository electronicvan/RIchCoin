...
public:
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        transactionFee->setStyleSheet(QLatin1String("border-top-left-radius: 5px;\n"
...
"max-width: 50px;"));
        ...
        proxyIp->setMaximumSize(QSize(154, 29));
        proxyIp->setStyleSheet(QLatin1String("\n"
...
"max-width: 150px;"));
        ...
        proxyPort->setMaximumSize(QSize(84, 29));
        proxyPort->setStyleSheet(QLatin1String("border-top-left-radius: 5px;\n"
"border-top-right-radius: 5px;\n"
"border-bottom-left-radius: 5px;\n"
"border-bottom-right-radius: 5px;\n"
"border: 2px solid #000000;\n"
...
"max-width: 80px;"));
        ...
        socksVersion->setStyleSheet(QLatin1String("border-top-left-radius: 5px;\n"
"border-top-right-radius: 5px;\n"
"border-bottom-left-radius: 5px;\n"
"border-bottom-right-radius: 5px;\n"
"border: 2px solid #000000;\n"
...
"max-width: 80px;"));
        ...
        lang->setStyleSheet(QLatin1String("\n"
"border-top-left-radius: 5px;\n"
"border-top-right-radius: 5px;\n"
"border-bottom-left-radius: 5px;\n"
"border-bottom-right-radius: 5px;\n"
...
"max-width: 300px;"));
        ...
        unit->setStyleSheet(QLatin1String("\n"
"border-top-left-radius: 5px;\n"
"border-top-right-radius: 5px;\n"
"border-bottom-left-radius: 5px;\n"
"border-bottom-right-radius: 5px;\n"
...
"max-width: 100px;"));
        ...
        okButton->setStyleSheet(QLatin1String("\n"
"border-top-left-radius: 5px;\n"
"border-top-right-radius: 5px;\n"
"border-bottom-left-radius: 5px;\n"
"border-bottom-right-radius: 5px;\n"
...
"max-width: 100px;"));
        ...
        cancelButton->setStyleSheet(QLatin1String("\n"
"border-top-left-radius: 5px;\n"
"border-top-right-radius: 5px;\n"
"border-bottom-left-radius: 5px;\n"
"border-bottom-right-radius: 5px;\n"
...
"max-width: 100px;"));
        ...
        applyButton->setStyleSheet(QLatin1String("\n"
"border-top-left-radius: 5px;\n"
"border-top-right-radius: 5px;\n"
"border-bottom-left-radius: 5px;\n"
"border-bottom-right-radius: 5px;\n"
...
"max-width: 100px;"));
    ...
    void retranslateUi(QDialog *OptionsDialog)
    {
        ...
        bitcoinAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start RIchCoin after logging in to the system.", 0));
#endif // QT_NO_TOOLTIP
        bitcoinAtStartup->setText(QApplication::translate("OptionsDialog", "&Start RIchCoin on system login", 0));
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the RIchCoin client port on the router. This only works when your router supports UPnP and it is enabled.", 0));
#endif // QT_NO_TOOLTIP
        mapPortUpnp->setText(QApplication::translate("OptionsDialog", "Map port using &UPnP", 0));
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the RIchCoin network through a SOCKS proxy (e.g. when connecting through Tor).", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        lang->setToolTip(QApplication::translate("OptionsDialog", "The user interface language can be set here. This setting will take effect after restarting RIchCoin.", 0));
#endif // QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        displayAddresses->setToolTip(QApplication::translate("OptionsDialog", "Whether to show RIchCoin addresses in the transaction list or not.", 0));
#endif // QT_NO_TOOLTIP
