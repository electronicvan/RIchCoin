...
public:
    ...
    void setupUi(QDialog *SignVerifyMessageDialog)
    {
        ...
        addressIn_SM->setStyleSheet(QLatin1String("border-top-left-radius: 5px;\n"
...
"max-height: 25px;"));
        ...
        addressBookButton_SM->setStyleSheet(QLatin1String("border-top-left-radius: 5px;\n"
"border-top-right-radius: 5px;\n"
"border-bottom-left-radius: 5px;\n"
"border-bottom-right-radius: 5px;\n"
""));
        ...
        pasteButton_SM->setStyleSheet(QLatin1String("border-top-left-radius: 5px;\n"
"border-top-right-radius: 5px;\n"
"border-bottom-left-radius: 5px;\n"
"border-bottom-right-radius: 5px;"));
        QIcon icon1;
        ...
        messageIn_SM->setStyleSheet(QLatin1String("border-top-left-radius: 5px;\n"
"border-top-right-radius: 5px;\n"
"border-bottom-left-radius: 5px;\n"
"border-bottom-right-radius: 5px;\n"
"border: 2px solid #000000;\n"
...
"max-height: 150px;"));
        ...
        signatureOut_SM->setStyleSheet(QLatin1String("border-top-left-radius: 5px;\n"
"border-top-right-radius: 5px;\n"
"border-bottom-left-radius: 5px;\n"
"border-bottom-right-radius: 5px;\n"
"border: 2px solid #000000;\n"
...
"max-height: 25px;"));
        ...
        copySignatureButton_SM->setStyleSheet(QLatin1String("border-top-left-radius: 5px;\n"
"border-top-right-radius: 5px;\n"
"border-bottom-left-radius: 5px;\n"
"border-bottom-right-radius: 5px;\n"
"\n"
...
""));
        ...
        signMessageButton_SM->setStyleSheet(QLatin1String("border-top-left-radius: 5px;\n"
"border-top-right-radius: 5px;\n"
"border-bottom-left-radius: 5px;\n"
"border-bottom-right-radius: 5px;\n"
...
""));
        ...
        clearButton_SM->setStyleSheet(QLatin1String("border-top-left-radius: 5px;\n"
"border-top-right-radius: 5px;\n"
"border-bottom-left-radius: 5px;\n"
"border-bottom-right-radius: 5px;\n"
"border: 1px solid #000000;\n"
...
"max-width: 90px;"));
        ...
        addressIn_VM->setStyleSheet(QLatin1String("border-top-left-radius: 5px;\n"
"border-top-right-radius: 5px;\n"
"border-bottom-left-radius: 5px;\n"
"border-bottom-right-radius: 5px;\n"
"border: 2px solid #000000;\n"
...
""));
        ...
        addressBookButton_VM->setStyleSheet(QLatin1String("border-top-left-radius: 5px;\n"
"border-top-right-radius: 5px;\n"
"border-bottom-left-radius: 5px;\n"
"border-bottom-right-radius: 5px;\n"
"\n"
...
""));
        ...
        messageIn_VM->setStyleSheet(QLatin1String("border-top-left-radius: 5px;\n"
"border-top-right-radius: 5px;\n"
"border-bottom-left-radius: 5px;\n"
"border-bottom-right-radius: 5px;\n"
"border: 2px solid #000000;\n"
...
"max-height: 150px;"));
        ...
        signatureIn_VM->setStyleSheet(QLatin1String("border-top-left-radius: 5px;\n"
"border-top-right-radius: 5px;\n"
"border-bottom-left-radius: 5px;\n"
"border-bottom-right-radius: 5px;\n"
"border: 2px solid #000000;\n"
...
"max-height: 25px;"));
        ...
        verifyMessageButton_VM->setStyleSheet(QLatin1String("border-top-left-radius: 5px;\n"
"border-top-right-radius: 5px;\n"
"border-bottom-left-radius: 5px;\n"
"border-bottom-right-radius: 5px;\n"
"border: 1px solid #000000;\n"
...
""));
        ...
        clearButton_VM->setStyleSheet(QLatin1String("border-top-left-radius: 5px;\n"
"border-top-right-radius: 5px;\n"
"border-bottom-left-radius: 5px;\n"
"border-bottom-right-radius: 5px;\n"
"border: 1px solid #000000;\n"
...
#ifndef QT_NO_TOOLTIP
        signMessageButton_SM->setToolTip(QApplication::translate("SignVerifyMessageDialog", "Sign the message to prove you own this RIchCoin address", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        verifyMessageButton_VM->setToolTip(QApplication::translate("SignVerifyMessageDialog", "Verify the message to ensure it was signed with the specified RIchCoin address", 0));
#endif // QT_NO_TOOLTIP
