...
public:
    ...
    void setupUi(QDialog *RPCConsole)
    {
        ...
        openDebugLogfileButton->setStyleSheet(QLatin1String("border-top-left-radius: 5px;\n"
...
"max-height: 25px;"));
        ...
        messagesWidget->setStyleSheet(QLatin1String("\n"
...
"border: 2px solid #000000;"));
    ...
    {
        RPCConsole->setWindowTitle(QApplication::translate("RPCConsole", "RIchCoin - Debug window", 0));
        label_9->setText(QApplication::translate("RPCConsole", "RIchCoin Core", 0));
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the RIchCoin debug log file from the current data directory. This can take a few seconds for large log files.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        showCLOptionsButton->setToolTip(QApplication::translate("RPCConsole", "Show the RIchCoin-Qt help message to get a list with possible RIchCoin command-line options.", 0));
#endif // QT_NO_TOOLTIP
