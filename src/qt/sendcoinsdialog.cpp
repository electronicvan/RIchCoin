    ...
    model(0)
{
    ...
    ui->lineEditCoinControlChange->setPlaceholderText(tr("Enter a RIchCoin address (e.g. 1NS17iag9jJgTHD1VXjvLCEnZuQ3rJDE9L)"));
#endif
...
void SendCoinsDialog::on_sendButton_clicked()
{
    ...
    case WalletModel::InvalidAmount:
        QMessageBox::warning(this, tr("Send Coins"),
            tr("Please send greater than 0.05 XRI."),
            QMessageBox::Ok, QMessageBox::Ok);
        break;
